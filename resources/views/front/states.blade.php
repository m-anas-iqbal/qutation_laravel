...
{{--                              {{ $name }} Traders--}}
                      ...
                      {{--<li>--}}
                          {{--<h2><a href="{{ url('traders', $name) }}" style="float: right"> Show all Traders </a></h2>--}}
                      {{--</li>--}}
                  </ul>
                    <hr>
                </div>
                {{--@foreach($states as $data)--}}
                    {{--<div class="col-sm-12 col-md-4 col-lg-4">--}}
                        {{--<h5>--}}
                            {{--<a href="{{ url('state-counties/'.$name.'/'.$data->name) }}">{{ $data->name }}</a>--}}
                        {{--</h5>--}}
                    {{--</div>--}}
                {{--@endforeach--}}
            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="card border-0 mb-4 shadow-lg ">
                                                <div class="card-body p-4 openPostions">
                                                    <h2>
                                                        <a href="{{ route('trader.details',$user->name) }}">{{ $user->name }}</a>
                                                    </h2>
                                                    <ul class="job-info">
                                                    ...
                                                    <ul class="job-info mt-4">
                                                        <li>
                                                            <a  id="user_tel1" class="btn btn-info" href="tel:{{ $user->phone }}"
                                                               aria-label="Click to call .'{{ $user->name }}'. on .'{{ $user->phone }}'."
                                                               style="border-radius: 18px;">{{ $user->phone }}</a>
                                                        </li>


                                                        {{--<li>--}}
                                                            {{--<a  id="user_tel2" href="tel:+442034881842"><i class="fa fa-phone"></i> 02034881842</a>--}}
                                                        {{--</li>--}}

                                                        {{--                                    @if(Auth::user())--}}
                                                        {{--<li>--}}
                                                            {{--<a href="{{ route('request.quote',$user->id) }}"--}}
                                                               {{--class="btn btn-success" style="border-radius: 18px;">Request--}}
                                                                {{--a Quote</a>--}}
                                                        {{--</li>--}}
                                                        <li>
                                                            <a href="#"
...
{{--    @include('front.includes.area_description')--}}
...
@section('script')
    ...
    {{--<script>--}}
        {{--function callPhone(id){--}}
            {{--let tel = $('#user_tel+id[href^="tel:"]');--}}
            {{--// console.log($("#user_tel").attr("href"));--}}
            {{--let globalLatitude--}}
            {{--let globalLongitude--}}
            {{--let globalCity--}}
            {{--let globalPostal--}}
