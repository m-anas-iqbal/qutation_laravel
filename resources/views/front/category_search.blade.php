                ...
                <div class="col">
                    <nav aria-label="breadcrumb" style="padding-top: 80px">
                        <ol class="breadcrumb">
                            ...
                            @if(isset($city))
                                <li class="breadcrumb-item" aria-current="page"><a href="{{ url('/a', $country) }}">{{ $country }}</a></li>
                                <li class="breadcrumb-item" aria-current="page"><a href="{{ url('/a'.'/'. $country.'/'.$state) }}">{{ $state }}</a></li>
                                <li class="breadcrumb-item" aria-current="page"><a href="{{ url('/a/'.$country.'/'.$state.'/'.$county) }}">{{ $county }}</a></li>
                                <li class="breadcrumb-item" aria-current="page"><a href="{{ url('/a/'.$country.'/'.$state.'/'.$county.'/'.$city) }}">{{ $city }}</a></li>
                                <li class="breadcrumb-item" aria-current="page"><a href="#">{{ $name }}</a></li>
                            ...
                            @elseif(isset($county))
                                ...
                                <li class="breadcrumb-item" aria-current="page"><a href="{{ url('/a'.'/'. $country.'/'.$state) }}">{{ $state }}</a></li>
                                <li class="breadcrumb-item" aria-current="page"><a href="{{ url('/a/'.$country.'/'.$state.'/'.$county) }}">{{ $county }}</a></li>
                                <li class="breadcrumb-item" aria-current="page"><a href="{{ url('/a/'.$country.'/'.$state.'/'.$county.'/'.$name) }}">{{ $name }}</a></li>

                            @elseif(isset($state))
                                <li class="breadcrumb-item" aria-current="page"><a href="{{ url('/a', $country) }}">{{ $country }}</a></li>
                                <li class="breadcrumb-item" aria-current="page"><a href="{{ url('/a'.'/'. $country.'/'.$state) }}">{{ $state }}</a></li>
                                <li class="breadcrumb-item" aria-current="page"><a href="{{ url('/a/'.$country.'/'.$state.'/'.$name) }}">{{ $name }}</a></li>
                            @elseif(isset($country))
                                <li class="breadcrumb-item" aria-current="page"><a href="{{ url('/a', $country) }}">{{ $country }}</a></li>
                                <li class="breadcrumb-item" aria-current="page"><a href="{{ url('/a/'.$country.'/'.$name) }}">{{ $name }}</a></li>
                            @else
                            <li class="breadcrumb-item" aria-current="page"><a href="{{ url('/a', $name) }}">{{ $name }}</a></li>
                            @endif
                ...
                <div class="col-12 col-md-12">
                    <ul class="job-info  align-items-center justify-content-between"> <li>
                            <h1>
                                ...
                                $filter_data = str_replace('{category}', $bname, $filter_data)
                                ?>
                                {!!  $filter_data !!}
{{--                                {!! str_replace('{h1_variable}', $bname, setting()->h1_variable) !!}--}}
                                {{--{{ $bname }} Traders--}}
                            </h1>
                        </li>
                    </ul>
