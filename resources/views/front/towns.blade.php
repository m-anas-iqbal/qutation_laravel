                ...
                <div class="col">
                    <nav aria-label="breadcrumb" style="padding-top: 80px">
                        <ol class="breadcrumb">
                            ...
                            @if(isset($town->postcode))
                            <li>
                            <a href="{{ url('ab/'.$country.'/'.$state.'/'.$county .'/'.$town->half_postcode) }}" style="margin-left: 35px;
            ...
            {{--<div class="row align-items-center" style="padding: 0px 0px 80px 0px;">--}}
                {{--<div class="col-12 col-md-12">--}}
                    {{--<ul class="job-info  align-items-center justify-content-between"> <li>--}}
                        ...
                        {{--</li>--}}
                        {{--<li>--}}
                            {{--<h2><a href="{{ url('traders/'.$country.'/'.$state.'/'.$county .'/'. $name) }}" style="float: right"> Show all Traders </a></h2>--}}
                        {{--</li>--}}
                    {{--</ul>--}}
                {{--</div>--}}
                {{--@foreach($towns as $data)--}}
                    {{--<div class="col-sm-12 col-md-4 col-lg-4">--}}
                        {{--<h5>--}}
                            {{--<a href="{{ url('traders/'.$country.'/'.$state.'/'.$county .'/'. $data->name) }}">{{ $data->name }}</a>--}}
                        {{--</h5>--}}
                    {{--</div>--}}
                {{--@endforeach--}}
            {{--</div>--}}
