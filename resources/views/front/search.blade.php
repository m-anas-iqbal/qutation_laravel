                ...
                <div class="col">
                    <nav aria-label="breadcrumb" style="padding-top: 80px">
                        <ol class="breadcrumb">
                            ...
                            @if($name)
                                <li class="breadcrumb-item" aria-current="page"><a href="{{ url('/search-by-ca/'.$name.'/'.$area_name) }}">{{ $name }}</a></li>
                            @endif
            ...
            <div class="row align-items-center" style="">
                <div class="col-12 col-md-12">
                    <h1>
                        ...
                        ?>
                        {!!  $filter_data !!}
{{--                        {!! str_replace('{h1_variable}', $name, setting()->h1_variable) !!}--}}
                        <hr>
                    </h1>
                </div>
            </div>
                                                ...
                                                <ul class="job-info">
                                                    @if(!isset($postcode_status))
                                                        <li><svg class="mb-1" xmlns="http://www.w3.org/2000/svg" width="16"
                                                            ...
                                                            </svg> <span style="text-transform:uppercase">{{ $area_name }}</span></li>
