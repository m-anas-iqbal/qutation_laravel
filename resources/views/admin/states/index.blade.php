...
@section('content')
    ...
    <div class="d-flex flex-column flex-md-row align-items-center jobTitlePadding">
        <h2 class="my-0 mr-md-auto">Manage States</h2>
        <button class="btn btn-lg btn-primary my-2 my-md-0 " data-toggle="modal" data-target="#add-state">Add State</button>
    </div>
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6">
                {{--<a class="btn btn-info"--}}
                   {{--href="{{ route('state-export') }}" style="float: right;margin-right: 32px;">--}}
                    {{--Export State Data--}}
                {{--</a>--}}
    ...
    <div class="modal" id="add-state" tabindex="-1" role="dialog">
    ...
    <div class="modal" id="delete-state" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-footer">
                    <form action="" method="POST" id="delete-state-form">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-primary">
                            Submit
...
@section('js')
    ...
    <script>
        ...
        //     $("#edit-state-form").prop('action', $(this).data('action'));
        //     $("#name").val($(this).data('name'));
        // });

        $(document).on('click', '.delete-state', function() {
            $("#delete-state-form").prop('action', $(this).data('action'));
        });
    </script>
