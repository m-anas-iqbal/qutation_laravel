...
@section('content')
    ...
    <div class="d-flex flex-column flex-md-row align-items-center jobTitlePadding">
        <h2 class="my-0 mr-md-auto">Manage Counties</h2>
        <button class="btn btn-lg btn-primary my-2 my-md-0 " data-toggle="modal" data-target="#add-county">Add County</button>
    </div>
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6">
                {{--<a class="btn btn-info"--}}
                   {{--href="{{ route('county-export') }}" style="float: right;margin-right: 32px;">--}}
                    {{--Export County Data--}}
                {{--</a>--}}
    ...
    <div class="modal" id="add-county" tabindex="-1" role="dialog">
    ...
    <div class="modal" id="delete-county" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-footer">
                    <form action="" method="POST" id="delete-county-form">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-primary">
                            Submit
...
@section('js')
    ...
    <script>
        ...
        $(document).on('click', '.delete-county', function() {
            $("#delete-county-form").prop('action', $(this).data('action'));
        });
    </script>
