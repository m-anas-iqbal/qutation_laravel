...
@section('content')
    ...
    <div class="d-flex flex-column flex-md-row align-items-center jobTitlePadding">
        <h2 class="my-0 mr-md-auto">Manage Sub Categories</h2>
        <button class="btn btn-lg btn-primary my-2 my-md-0 " data-toggle="modal" data-target="#add-category">Add Sub Category</button>
    </div>
    ...
    <div class="modal" id="add-category" tabindex="-1" role="dialog">
    ...
    <div class="modal" id="delete-category" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <script>
        $(document).ready(function() {
            $('#html5-extension').DataTable({
                ...
                "ajax": {
                    "url": SITE_URL + "/business-sub-categories-list",
                    "dataType": "json",
                    "type": "POST",
                    "data": {
                        _token: CSRF_TOKEN
        ...
        $(document).on('click', '.delete-category', function() {
            $("#delete-category-form").prop('action', $(this).data('action'));
        });
    </script>
